...
class CustomFieldsTests
{
    ...
    void shouldAddValueWithCorrectKey()
    {
        ...
        CustomFields.VIVIDUS.add(payload, VIVIDUS);
        CustomFields.PLUGIN_VERSION.add(payload, PLUGIN);
        CustomFields.JAVA.add(payload, JAVA);
        CustomFields.PROFILE.add(payload, PROFILE);
        CustomFields.STEPS.add(payload, STEPS);
        CustomFields.STORIES.add(payload, STORIES);
        CustomFields.DURATION.add(payload, DURATION);
        CustomFields.REMOTE.add(payload, REMOTE);
        CustomFields.SCENARIOS.add(payload, SCENARIOS);
