...
public class VividusWebDriverFactory extends AbstractVividusDriverFactory
{
    ...
    {
        super(bddRunContext, webDriverManagerContext, proxy);
    ...
    protected void configureVividusWebDriver(VividusWebDriver vividusWebDriver)
    {
        ...
        WebDriver webDriver = isRemoteExecution()
                ...
                : webDriverFactory.getWebDriver(capabilities);

        EventFiringWebDriver eventFiringWebDriver = new EventFiringWebDriver(webDriver);
        webDriverEventListeners.forEach(eventFiringWebDriver::register);

        webDriverManager.resize(browserWindowSizeProvider.getBrowserWindowSize(isRemoteExecution()));
        vividusWebDriver.setWebDriver(eventFiringWebDriver);
        vividusWebDriver.setRemote(isRemoteExecution());
    }
